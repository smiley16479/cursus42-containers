...
class RBTree; // VOICI COMMENT METTRE UN MEMBRE RBTree ALORS QU'IL EST DÉCLARÉ PLUS BAS l.27


class my_iterator
{
    public:
        RBTree * tree; // <- Ici (ne sert à rien, juste à montrer commment faire une déclaration imbriqué)
        Node *_baseRoot;
        Node *_root;
